 ...
 * the form on the right. The panel renders FM's
 * `illustration-authentication.svg` as its backdrop, with the wordmark and
 * tagline overlaid on top.
 */
function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <div className="flex min-h-screen flex-col lg:flex-row lg:gap-0 lg:bg-background lg:p-5">
      ...
      <aside className="relative hidden shrink-0 overflow-hidden rounded-xl bg-grey-900 lg:flex lg:w-[560px] xl:w-[600px]">
        <img
